...
std::string AuthenticationServer::GetTGSKey() const {
    return tgs_key;
}
...
AuthenticationServer::authenticate(const AuthenticationToken &authenticationToken, const std::string &tg_name) const {
    ...
    std::cout << "Authentication server generated TGS_SESSION key: " << session_key << std::endl;
    ...
    std::cout << "Authentication server generated current timestamp: " << current_timestamp << std::endl;
...
TicketGrantingServerAddressToken AuthenticationServer::generate_tgs_address_token(
        ...
        const boost::posix_time::ptime& current_timestamp,
    ...
    TicketGrantingServerAddressToken tgs_address_token(
            ...
            boost::posix_time::to_simple_string(current_timestamp)
    );
    ...
    std::cout << "   current_timestamp: " << tgs_address_token.current_timestamp << std::endl;
...
TicketGrantingTicket AuthenticationServer::generate_tgt(
    ...
    std::cout << "   tgs_server: " << tgt.tg_name << std::endl;
    std::cout << "   expiration_timestamp: " << tgt.expiration_timestamp << std::endl;
    std::cout << "   current_timestamp: " << tgt.current_timestamp << std::endl;
